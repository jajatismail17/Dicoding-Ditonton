...
class SeriesRepositoryImpl implements SeriesRepository {
  ...
  Future<Either<Failure, String>> saveWatchlist(SeriesDetail series) async {
    try {
      final result = await localDataSource.insertWatchlist(SeriesTable.fromEntity(series));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeWatchlist(SeriesDetail series) async {
    try {
      final result = await localDataSource.removeWatchlist(SeriesTable.fromEntity(series));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
