...
void main() {
  ...
  group('get TV Series On The Air ', () {
    ...
    final tSeriesList = seriesResponse.seriesList;
  ...
  group('get Popular TV Series', () {
    ...
    test('should return list of series when response is success (200)', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('dummy_data/popular_series.json'), 200));
      // act
  ...
  group('get Top Rated Series', () {
    ...
    test('should return list of series when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('dummy_data/top_rated_series.json'), 200));
      // act
  ...
  group('get series detail', () {
    ...
    test('should return series detail when the response code is 200', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('dummy_data/series_detail.json'), 200));
      // act
  ...
  group('get series recommendations', () {
    ...
    test('should return list of Series Model when the response code is 200', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId/recommendations?$API_KEY')))
          .thenAnswer((_) async => http.Response(readJson('dummy_data/series_recommendations.json'), 200));
      // act
  ...
  group('search tv series', () {
    final tSearchResult = SeriesResponse.fromJson(json.decode(readJson('dummy_data/search_avatar_series.json'))).seriesList;
    const tQuery = 'avatar';

    test('should return list of tv series when response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/search/tv?$API_KEY&query=$tQuery')))
          .thenAnswer((_) async => http.Response(readJson('dummy_data/search_avatar_series.json'), 200));
      // act
